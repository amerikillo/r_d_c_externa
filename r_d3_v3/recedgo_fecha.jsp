  ...
  <tr>
    <td width="956" height="114"><table width="837" border="0" align="center" cellpadding="2">
      ...
      <tr>
        ...
        RECETA M&Eacute;DICA <br /> CONSULTA EXTERNA</div>
        ...
        <tr>
          <td height="38" colspan="3" class="style4"><table width="763" border="0" align="center" cellpadding="2">
            <tr>
              ...
              NOMBRE:
              <input name="txtf_nomed" id="txtf_nomed" type="text" onkeypress="return soloLetras(event);" onfocusout="this.value=this.value.toUpperCase()" class="style13" value="<%=nomed_jv%>" size="35"  onKeyPress="return handleEnter(this, event)" />
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="875" border="0" align="center" cellpadding="2">
            ...
            <tr>
			 ...
			 <%
			 int ban_imp=0;
  Connection conn__001 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");

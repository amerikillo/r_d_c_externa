...
Connection connPaso = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
...
<table width="1021" border="0" align="center" cellpadding="2">
  <tr>
    ...
    PERIODO: <%=date1_jv%> al <%=date2_jv%><br /> CONSULTA EXTERNA</span><br />
    <br />
    </div></td>

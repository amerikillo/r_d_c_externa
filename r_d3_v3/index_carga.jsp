...
{
          conn_2 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body bgcolor="#C0DFFD" onload="fillCategory_uni()">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <tr bgcolor="" >
                <td height="44" colspan="3" align="center" valign="top" style="background-color:#FFFFFF; color:#000000" ><div align="center" ><br /> <h3>CONSULTA EXTERNA</h3>	</div>
            </tr>

...
Connection conexion=null;
   ...
   /*parametros para la conexion*/
    ...
    String url = "jdbc:mysql://localhost:3306/r_d_c_externa";
    String usuario = "root";
    String pass = "eve9397";
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="721" border="0" align="left" cellpadding="2">
        <tr>
          <td width="509"><div align="center" class="style5 style6">SISTEMA REPORTEADOR COMPRAS<br /> CONSULTA EXTERNA</div></td>

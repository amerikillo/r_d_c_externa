...
Class.forName("org.gjt.mm.mysql.Driver");
				  ...
				  Connection conn = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa");
        ...
        <tr>
          <td height="219" colspan="3" class="style4"><table width="875" border="0" align="center" cellpadding="2">
            ...
            <tr>
			 ...
			 <%
  Connection conn__001 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa");

...
Connection conn1 = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
...
// Rutina para fechas
		 ...
		 if( (month>=1 && (years>=113 || years<=108))  || (month2>=11 && (years2>=113 || years<=108)) )
		     {bancom=30;}
		 Connection conne_d = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
		...
		if(monthMa < month2 || month < monthMi){
		 banexi=0;
		 		   ...
		 		   Connection conne_day = DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
  ...
  <tr bgcolor="#D5EDB3">
    ...
    <td height="50" colspan="3" align="center" valign="bottom" nowrap="nowrap" bgcolor="#FFFFFF" id="logo"><div align="right">
      <table width="946" border="0" align="left" cellpadding="2">
        <tr>
          <td width="870" rowspan="2"><div align="center" class="style5 style6">SISTEMA REPORTEADOR DE VALIDACIONES POR MES RECETA POR FARMACIA <br /> CONSULTA EXTERNA</div></td>
  ...
  <tr>
    ...
    <td colspan="2" valign="top"><div align="center"></div>
      ...
      <table width="925" border="3" align="left" cellpadding="0" cellspacing="0">
		...
		String fechaa2_jv="";
		      	  Connection connn = 
		      	         DriverManager.getConnection("jdbc:mysql://localhost/r_d_c_externa", "root", "eve9397");
